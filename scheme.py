...
Original file is located at
    https://colab.research.google.com/drive/1HJhUDB6JHGNIVO_8kewKUJUsSQmP05Zw
"""
...
# Drop the original 'Age' column as it's no longer needed if it exists
df.drop(columns=['Age'], inplace=True, errors='ignore')

# Now apply one-hot encoding to the rest of the DataFrame
df = pd.get_dummies(df, drop_first=True)

df.drop(columns=['benefit_amount'], inplace=True, errors='ignore')

# The age_range calculation has been moved to an earlier cell (22fzYSciUTfS) to ensure min_age and max_age exist.
# This cell now only contains the plotting code.
...
# Create the 'eligible' column based on 'age_range' as 'priority_score' is not available
